  ...
  return (
    <div className="bg-white rounded-apple-2xl shadow-[0_4px_24px_rgba(0,0,0,0.04)] overflow-hidden h-full flex flex-col">
      ...
      <div className="p-8 flex flex-col flex-1">
        <h3 className="text-xl font-bold text-ejn-teal mb-3">Aceleração de Futuros Líderes 2026</h3>
        <p className="text-apple-text-secondary text-sm mb-8 leading-relaxed">
          Impulsionando o próximo ciclo de alto desempenho para 50 jovens talentos de comunidades sub-representadas. 
        </p>
        
        <div className="mt-auto">
          <div className="flex justify-between items-center mb-4">
            <span className="text-xs font-bold text-gray-400 uppercase">Captação Estratégica</span>
